	...
	if (wp_miniprogram_option('advert')) {
		$options['adsense-setting'] = [
			...
			'fields'=> [
				...
				'ad_i_type'			=>['title'=>'广告类型','type'=>'select','options'=>['wechat'=>'微信广告组件','tencent'=>'QQ 广告组件','baidu'=>'百度广告组件','weapp'=>'微信小程序','txapp'=>'QQ 小程序','bdapp'=>'百度小程序','picture'=>'活动广告','site'=>'网站链接','taobao'=>'淘宝口令']],
				'ad_i_platform'		=>['title'=>'投放平台','type'=>'mu-check','options'=>['weapp'=>'微信小程序','qq'=>'QQ 小程序','smartapp'=>'百度智能小程序']],
				...
				'ad_t_type'			=>['title'=>'广告类型','type'=>'select','options'=>['wechat'=>'微信广告组件','tencent'=>'QQ 广告组件','baidu'=>'百度广告组件','weapp'=>'微信小程序','txapp'=>'QQ 小程序','bdapp'=>'百度小程序','picture'=>'活动广告','site'=>'网站链接','taobao'=>'淘宝口令']],
				'ad_t_platform'		=>['title'=>'投放平台','type'=>'mu-check','options'=>['weapp'=>'微信小程序','qq'=>'QQ 小程序','smartapp'=>'百度智能小程序']],
				...
				'ad_d_type'			=>['title'=>'广告类型','type'=>'select','options'=>['wechat'=>'微信广告组件','tencent'=>'QQ 广告组件','baidu'=>'百度广告组件','weapp'=>'微信小程序','txapp'=>'QQ 小程序','bdapp'=>'百度小程序','picture'=>'活动广告','site'=>'网站链接','taobao'=>'淘宝口令']],
				'ad_t_platform'		=>['title'=>'投放平台','type'=>'mu-check','options'=>['weapp'=>'微信小程序','qq'=>'QQ 小程序','smartapp'=>'百度智能小程序']],
				...
				'ad_p_type'			=>['title'=>'广告类型','type'=>'select','options'=>['wechat'=>'微信广告组件','tencent'=>'QQ 广告组件','baidu'=>'百度广告组件','weapp'=>'微信小程序','txapp'=>'QQ 小程序','bdapp'=>'百度小程序','picture'=>'活动广告','site'=>'网站链接','taobao'=>'淘宝口令']],
				'ad_t_platform'		=>['title'=>'投放平台','type'=>'mu-check','options'=>['weapp'=>'微信小程序','qq'=>'QQ 小程序','smartapp'=>'百度智能小程序']],
