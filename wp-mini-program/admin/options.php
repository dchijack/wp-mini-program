	...
	if (wp_miniprogram_option('advert')) {
		$options['adsense-setting'] = [
			...
			'fields'=> [
				...
				'ad_i_type'			=>['title'=>'广告类型','type'=>'select','options'=>['unitad'=>'流量主','app'=>'小程序','picture'=>'活动广告','site'=>'网站链接','taobao'=>'淘宝口令']],
				...
				'ad_t_type'			=>['title'=>'广告类型','type'=>'select','options'=>['unitad'=>'流量主','app'=>'小程序','picture'=>'活动广告','site'=>'网站链接','taobao'=>'淘宝口令']],
				...
				'ad_d_type'			=>['title'=>'广告类型','type'=>'select','options'=>['unitad'=>'流量主','app'=>'小程序','picture'=>'活动广告','site'=>'网站链接','taobao'=>'淘宝口令']],
				'ad_t_platform'		=>['title'=>'投放平台','type'=>'mu-check','options'=>['weapp'=>'微信小程序','qq'=>'QQ 小程序','baidu'=>'百度智能小程序']],
				...
				'ad_p_type'			=>['title'=>'广告类型','type'=>'select','options'=>['unitad'=>'流量主','app'=>'小程序','picture'=>'活动广告','site'=>'网站链接','taobao'=>'淘宝口令']],
				'ad_t_platform'		=>['title'=>'投放平台','type'=>'mu-check','options'=>['weapp'=>'微信小程序','qq'=>'QQ 小程序','baidu'=>'百度智能小程序']],
